...
Импорт именно из `vitest/config`: у `vite` в типе `UserConfig` нет ключа `test`, и `npm run typecheck` упадёт.
...
Заметка: `FillGradient` с объектным конструктором (`{ start, end, colorStops }`) — актуальный API Pixi 8.6+; позиционный `new FillGradient(0,0,0,1)` помечен deprecated, не использовать.
...
- [ ] **Step 3a: Записи героя в манифесте**

Добавить в `assets/manifest.json` → `entries` (нужны заглушкам правильного размера; промпты появятся на этапе 2):

```json
{ "id": "sp_hero_idle", "kind": "sprite", "group": "core", "character": "hero", "size": [700, 900], "file": "assets/img/sprites/hero_idle.webp", "model": "", "prompt": "", "generated": false },
{ "id": "sp_hero_attack", "kind": "sprite", "group": "core", "character": "hero", "size": [700, 900], "file": "assets/img/sprites/hero_attack.webp", "model": "", "prompt": "", "generated": false },
{ "id": "sp_hero_hurt", "kind": "sprite", "group": "core", "character": "hero", "size": [700, 900], "file": "assets/img/sprites/hero_hurt.webp", "model": "", "prompt": "", "generated": false },
{ "id": "sp_hero_win", "kind": "sprite", "group": "core", "character": "hero", "size": [700, 900], "file": "assets/img/sprites/hero_win.webp", "model": "", "prompt": "", "generated": false },
{ "id": "pt_hero_neutral", "kind": "portrait", "group": "core", "size": [512, 512], "file": "assets/img/portraits/hero_neutral.webp", "model": "", "prompt": "", "generated": false },
{ "id": "pt_hero_worried", "kind": "portrait", "group": "core", "size": [512, 512], "file": "assets/img/portraits/hero_worried.webp", "model": "", "prompt": "", "generated": false },
{ "id": "il_title", "kind": "illustration", "group": "core", "size": [1600, 900], "file": "assets/img/il/title.webp", "model": "", "prompt": "", "generated": false }
```

- [ ] **Step 3b: Минимальный `test/manifest.test.ts`**
...
Полная проверка циклов, бюджета веса и существования файлов — на этапе 2, когда появится `tools/manifest.ts`.
