...
**Статус:** этап 4 из 8 — ступени 0 (Милина, HR) и 1 (Барака, тимлид) написаны и проходятся в игре на заглушках; арт обеих ступеней (14 записей манифеста, ≈ $0.81) ждёт утверждения сюжета вместе с титулом, концовками, музыкой и диктором. Потрачено $0.43.
