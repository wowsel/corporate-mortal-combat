...
**Статус:** этап 8 из 8 и art-проход выполнены (2026-09-04): 68 ассетов (54 картинки, 6 музыкальных клипов, 8 реплик диктора) сгенерированы, отсмотрены и задеплоены на GitHub Pages. Потрачено ≈ $3.9 из бюджета $10 (герой $0.43 + art-проход ≈ $3.45, включая пересъёмки и бисект модерации).
