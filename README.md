...
**Статус:** этап 6 из 8 — ступени 0 (Милина, HR), 1 (Барака, тимлид), 2 (Китана, альянсы) и 3 (Синдел, финдиректор) написаны и проходятся в игре на заглушках; арт четырёх ступеней (28 записей манифеста, ≈ $1.65) ждёт утверждения сюжета вместе с титулом, концовками, музыкой и диктором. Потрачено $0.43.
