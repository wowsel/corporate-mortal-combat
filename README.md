...
**Статус:** этап 7 из 8 — ступени 0 (Милина, HR), 1 (Барака, тимлид), 2 (Китана, альянсы), 3 (Синдел, финдиректор) и 4 (Шанг Цунг, трансформация; Рептилия из поддержки) написаны и проходятся в игре на заглушках; арт пяти ступеней (36 записей манифеста, ≈ $2.10) ждёт утверждения сюжета вместе с титулом, концовками, музыкой и диктором. Потрачено $0.43.
